...
spec](http://tools.ietf.org/html/draft-dejong-remotestorage-10)'s REST API, versions 03–05; also valid for later versions but missing specs for some newer features.
